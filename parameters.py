...
parser.add_argument("--dataset1", help="name of the dataset", type=str,default="ut-zappos")
...
# parser.add_argument("--lr_sgd", help="learning rate for SGD", default=5e-05, type=int)
